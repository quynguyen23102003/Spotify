...
import static com.workshops.onlinemusicplayer.MPConstants.AUDIO_FOCUSED;
import static com.workshops.onlinemusicplayer.MPConstants.AUDIO_NO_FOCUS_CAN_DUCK;
import static com.workshops.onlinemusicplayer.MPConstants.AUDIO_NO_FOCUS_NO_DUCK;
...
import static com.workshops.onlinemusicplayer.MPConstants.VOLUME_DUCK;
import static com.workshops.onlinemusicplayer.MPConstants.VOLUME_NORMAL;
...
public class PlayerManager implements MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnPreparedListener {
    ...
    private void initMediaPlayer() {
        ...
        tryToGetAudioFocus();
        Uri trackUri = Uri.parse(playerQueue.getCurrentMusic().getResource());
